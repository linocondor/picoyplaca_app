        ...
        <div class="card-content"><div class="content">
            ...
            <div class="container">
                    ...
                    <div class="text is-size-6 has-text-centered">
                        ...
                        <p>Usted <b>NO</b> puede circular en su vehículo a la(s) <?= $hora ?> el día <?= $numeroDiaSemana ?> ( <?= $fecha ?> ) . Recuerde que, los días que no puede circular son los <?= $diaNoCircula ?> de 7:00 a 9:30 y de 16:00 a 19:30.</p>
                    </div>
